        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-4">
                    <button wire:click="setStatus('open')" class="text-white/90 hover:text-white flex items-center space-x-2 transition font-medium">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button wire:click="setStatus('Resolved')" 
                        ...
                        <button wire:click="setStatus('Paused')" 
        ...
        Add Incident Log
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-20">
                ...
                @foreach($this->filteredIncidents as $incident)
                    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-100 dark:border-slate-700 p-3 flex flex-col justify-between hover:shadow-md transition border-l-4 {{ getBorderClass($incident) }}">
                        ...
                        <div>
                            ...
                            <div class="mb-2">
                                <div class="flex items-baseline justify-between border-b border-dashed border-gray-200 dark:border-slate-600 pb-1">
                                    <h3 class="text-base font-bold text-gray-900 dark:text-white">{{ $incident['zone'] }}</h3>
                        ...
                        <div class="text-[12px] text-gray-600 dark:text-gray-400 space-y-1 mb-3">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-[11px]">{{ $incident['started'] }}</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-[11px]">{{ \Carbon\Carbon::parse($incident['etr'])->format('m/d/y, h:i A') }}</span>
                            </div>

                            @if($incident['status'] === 'Resolved' && !empty($incident['rt']))
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-[11px]">{{ $incident['rt'] }}</span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="flex justify-between items-center border-t dark:border-slate-700 pt-2 mt-auto">
                            <span class="text-[11px] font-semibold text-gray-700 dark:text-gray-300">{{ $incident['reporter'] }}</span>
                    ...
                    <div class="fixed inset-0 z-[60] overflow-y-auto">
                        <div class="relative min-h-screen flex items-center justify-center p-4">
                            <div class="relative bg-white dark:bg-slate-800 w-full max-w-lg rounded-2xl shadow-2xl p-6 border border-gray-200 dark:border-slate-700">
                                ...
                                <div class="mb-6">
                                    <h3 class="text-xl font-bold text-gray-900 dark:text-white">✏️ Edit Incident</h3>
                ...
                <div class="fixed inset-0 z-[60] overflow-y-auto">
                    <div class="relative min-h-screen flex items-center justify-center p-4">
                        <div class="relative bg-white dark:bg-slate-800 w-full max-w-2xl rounded-2xl shadow-2xl p-6 border border-gray-200 dark:border-slate-700">
                            ...
                            <button wire:click="$set('showAddModal', false)" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                            </button>
